...
import { font20, font17 } from '~/styles/fonts'
...
export function Panel() {
    return (
        <Box data-id='Panel' d='flex' alignItems='center' pt='9px' pb='9px'>
            <Box mr='4px'>
                <Box {...font17}>Live chat</Box>
                <Box d='flex' alignItems='baseline'>
                    <User />
                    <Box ml='6px' mt='1px' {...font17} lineHeight='21px' color='#606060'>
                        5K
                    </Box>
                </Box>
            </Box>
            <Box ml='auto' d='flex' alignItems='center'>
                <Gift />
                <Box ml='11px' mr='11px' color='#4B4B4B' {...font17} fontWeight='bold'>
                    Give a Free Gift
                </Box>
